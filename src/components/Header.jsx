...
const Header = ({ darkMode, setDarkMode }) => {
  ...
  return (
    <header className="bg-white dark:bg-gray-900 p-5 flex flex-col items-end pl-20 ">
      ...
      <div className="flex justify-center space-x-4 pr-12 gap-6">
        <a href="#" className="text-black dark:text-white px-4 py-2 ">
          Skills
        </a>
        <a href="" className="text-black dark:text-white  px-4 py-2 ">
          Projects
        ...
        <a
          href=""
          className="text-black dark:text-white border-2 border-blue-800 dark:border-white px-4 py-2 rounded shadow"
        >
          Hire me
        </a>
      </div>
