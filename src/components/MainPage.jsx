    ...
    <main className="bg-white dark:bg-gray-800 py-10">
      <div className="container mx-auto flex flex-col md:flex-row items-center">
        <div className="md:w-1/2 text-center md:text-left">
          <h1 className="text-black dark:text-white text-7xl font-bold mb-16 ">
            {title}
          </h1>
          <p className="text-gray-700 dark:text-gray-300 mb-6 text-l mb-16 container">
            {description}
          </p>
          <div className="flex justify-center md:justify-start space-x-4 text-2 xl">
            <a
              href="#"
